...
gen_params = {"drop_connect_rate": 0.2}
...
def efficientnet_b0(pretrained=True):
    return genm.create_model('tf_efficientnet_b0_ns', pretrained=pretrained, drop_rate=0.2, **gen_params)
def efficientnet_b3(pretrained=True):
    return genm.create_model('tf_efficientnet_b3_ns', pretrained=pretrained, drop_rate=0.3, **gen_params)
def efficientnet_b5(pretrained=True):
    return genm.create_model('tf_efficientnet_b5_ns', pretrained=pretrained, drop_rate=0.4, **gen_params)
def efficientnet_b7(pretrained=True):
    return genm.create_model('tf_efficientnet_b7_ns', pretrained=pretrained, drop_rate=0.5, **gen_params)
