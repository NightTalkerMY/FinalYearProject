...
ap.add_argument("-nC", "--n_classes", required=True, type=int, choices=[7,6, 13, 14, 16, 28, 45])
...
ds_directory = f"../splitted_datasets/{ds_directory}"
...
loss_func = e2eTunerLossWrapper(nOutputs=len(args.mv_orientations)+1) # add one because it includes the tuner
